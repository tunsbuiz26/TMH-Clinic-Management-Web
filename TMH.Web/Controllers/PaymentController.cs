...
namespace TMH.Web.Controllers
{
    public class PaymentController : Controller
    {
        ...
        // GET /Payment/PayNow/{appointmentId} — bệnh nhân chuyển từ thanh toán tiền mặt sang VNPay
        [HttpGet("Payment/PayNow/{appointmentId:int}")]
        public async Task<IActionResult> PayNow(int appointmentId)
        {
