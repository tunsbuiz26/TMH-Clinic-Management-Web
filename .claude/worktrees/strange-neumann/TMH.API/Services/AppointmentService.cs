...
namespace TMH.API.Services
{
    public class AppointmentService
    {
        ...
        public async Task<AppointmentResponseDto> BookAsync(BookAppointmentDto dto)
        {
            ...
            // 5. Tự động phát hiện tái khám:
            //    Nếu bệnh nhân đã có lịch hoàn thành với cùng bác sĩ → IsReturn = true
        ...
        // HUỶ LỊCH KHÁM
        // =====================================================================
        public async Task<AppointmentResponseDto> CancelAsync(int appointmentId, int userId, string? cancellationReason = null)
        {
