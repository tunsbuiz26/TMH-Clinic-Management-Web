...
namespace TMH.Web.Services
{
    ...
    public class ApiService
    {
        ...
        public async Task<AppointmentResponseDto?> CancelAppointmentAsync(int id, string? reason = null)
            => await PostAsync<AppointmentResponseDto>($"api/appointment/cancel/{id}", new { cancellationReason = reason });
        ...
        // =====================================================================
        // AI RECOMMENDATION — Gợi ý bác sĩ phù hợp theo triệu chứng
        // =====================================================================
