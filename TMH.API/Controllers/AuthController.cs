...
namespace TMH.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(AuthService authService, ILogger<AuthController> logger, AppDbContext db, EmailService emailSvc)
        {
        ...
        public async Task<IActionResult> UpdateMe([FromBody] UpdateProfileDto dto)
        {
            ...
            if (dto.SoCCCD != null) user.SoCCCD = dto.SoCCCD;
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordDto dto)
        {
            ...
            var result = await _authService.ForgotPasswordAsync(dto, _emailSvc);
            return Ok(result);
        }
        ...
        [AllowAnonymous]
        public async Task<IActionResult> ResetPassword([FromBody] TMH.Shared.DTOs.ResetPasswordDto dto)
        {
            if (!ModelState.IsValid)
        ...
        public async Task<IActionResult> TestEmail([FromQuery] string to)
        {
            ...
            await _emailSvc.SendBookingConfirmationAsync(
                toEmail    : to,
