    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Appointment>(e =>
            {
                ...
                e.Property(a => a.CancellationReason).HasMaxLength(200);
            ...
            {
                e.ToTable("ConversationParticipants");
                e.HasKey(p => p.Id);
            ...
            modelBuilder.Entity<Review>(e =>
            {
                e.ToTable("Reviews");
                e.HasKey(r => r.Id);
                e.HasIndex(r => r.AppointmentId).IsUnique(); // 1 lịch = 1 đánh giá
            ...
            {
                e.ToTable("CodeCounters");
                e.HasKey(c => c.Id);
                e.HasIndex(c => new { c.Scope, c.Year }).IsUnique();
                e.Property(c => c.Scope).HasMaxLength(50).IsRequired();
            });
